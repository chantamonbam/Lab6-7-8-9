Public Class frmLab8
    ...
    Private Sub frmLab8_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtScore_KeyPress(ByVal sender As Object, ByVal e As KeyPressEventArgs) Handles txtScore.KeyPress
